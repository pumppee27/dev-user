...
!(function (t, e) {
    ...
    n &&
      (!(function (t, e) {
        'string' == typeof e
          ...
          : e || it([document.documentElement, document.body], y['no-backdrop'])
      })(n, e.backdrop),
      (function (t, e) {
        if (!e) return
        e in y
  ...
  var xt = { innerParams: new WeakMap(), domCache: new WeakMap() },
    ...
    qt = {}
  ;(qt.text = qt.email = qt.password = qt.number = qt.tel = qt.url = qt.search = qt.date = qt[
    'datetime-local'
  ] = qt.time = qt.week = qt.month = function (t, e) {
  ...
  var ln = function (t) {
    ...
    yn = function (t, e, n) {
      e.container.onclick = function (o) {
        vn
          ? (vn = !1)
          : o.target === e.container && T(t.allowOutsideClick) && n($t.backdrop)
      }
    },
    wn = function (t) {
      return (
    ...
    Tn = Object.freeze({
      ...
      bindClickHandler: function () {
        ;(En[
          ...
          kn || (document.body.addEventListener('click', Bn), (kn = !0))
      },
