<div class="dropdown">
  ...
  " aria-labelledby="dropdownMenu">
    <li>
      <a href="/hak_akses_menu/k{{encrypt($id)}}" class="dropdown-item" data-id="{{$id}}">
    ...
    {{-- <li>
      <button class="dropdown-item" data-bs-toggle="modal" id="btn-detail-hak-akses-menu" data-id="{{$id}}" data-hak-akses-menu="{{$hak_akses_menu}}">
    ...
    <li>
      <button id="btn-delete-hak-akses-menu"class="dropdown-item" data-id="{{$id}}">
        <form>
          @csrf
          @method('delete')
