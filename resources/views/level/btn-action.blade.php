<div class="dropdown">
  ...
  <li>
      <button class="dropdown-item" data-bs-toggle="modal" id="btn-edit-level" data-id="{{$id}}" data-level="{{$level}}">
  ...
  <li>
      <button class="dropdown-item" data-bs-toggle="modal" id="btn-detail-level" data-id="{{$id}}" data-level="{{$level}}" >
  ...
  <li>
    <button id="btn-delete-level" class="dropdown-item" data-id="{{$id}}">
        <form>
            @csrf
            @method('delete')
