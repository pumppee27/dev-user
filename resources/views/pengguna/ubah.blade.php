...
<div class="card p-3">
    <div class="card-body">
      <div class="row">
        <h3 class="text-uppercase">Ubah Pengguna</h3>
      </div>
      <hr>
          ...
          <civ class="col-lg-6">
            ...
            {{-- <div class="mb-3">
              ...
              <div class="input-group">
                <input type="password" class="form-control" name="old_password" aria-describedby="basic-addon1" id="old_password_input">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <input type="password" class="form-control" name="password" id="password_input" value="{{old('password')}}" placeholder="Kosongkan bila tidak diubah">
