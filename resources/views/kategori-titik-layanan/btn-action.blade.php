<div class="dropdown">
  ...
  " aria-labelledby="dropdownMenu">
    <li>
      <a href="/kategori_titik_layanan/k{{encrypt($id)}}" class="dropdown-item" data-id="{{$id}}">
    ...
    {{-- <li>
      <button class="dropdown-item" data-bs-toggle="modal" id="btn-detail-kategori-titik-layanan" data-id="{{$id}}" data-kategori-titik-layanan="{{$nama_kategori_titik_layanan}}">
    ...
    <li>
      <button id="btn-delete-kategori-titik-layanan"class="dropdown-item" data-id="{{$id}}">
        <form>
          @csrf
          @method('delete')
