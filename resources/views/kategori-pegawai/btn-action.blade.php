<div class="dropdown">
  ...
  " aria-labelledby="dropdownMenu">
    <li>
      <a href="/kategori_pegawai/k{{encrypt($id)}}" class="dropdown-item" data-id="{{$id}}">
    ...
    {{-- <li>
      <button class="dropdown-item" data-bs-toggle="modal" id="btn-detail-kategori-pegawai" data-id="{{$id}}" data-kategori-pegawai="{{$kategori_pegawai}}">
    ...
    <li>
      <button id="btn-delete-kategori-pegawai"class="dropdown-item" data-id="{{$id}}">
        <form>
          @csrf
          @method('delete')
