<div class="dropdown">
  ...
  " aria-labelledby="dropdownMenu">
    <li>
      <a href="/pejabat/e{{encrypt($id)}}" class="dropdown-item" data-id="{{$id}}">
    ...
    {{-- <li>
      <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-detail-uppd" id="btn-detail-uppd" data-id="{{$id}}">
    ...
    <li>
      <button id="btn-delete-pejabat" class="dropdown-item" data-id="{{$id}}">
        <form>
          @csrf
          @method('delete')
