<div class="dropdown">
  ...
  " aria-labelledby="dropdownMenu">
    <li>
      <a href="/titik_layanan/e{{encrypt($lokasi_id)}}" class="dropdown-item" data-id="{{$id}}">
    ...
    {{-- <li>
      <button class="dropdown-item" data-bs-toggle="modal" id="btn-detail-titik-layanan" data-id="{{$id}}" data-titik-layanan="{{$nama_titik_layanan}}" data-uppd="{{$nama_uppd}}" data-kategori-titik-layanan="{{$nama_kategori_titik_layanan}}">
    ...
    <li>
      <button id="btn-delete-titik-layanan"class="dropdown-item" data-id="{{$lokasi_id}}">
        <form>
          @csrf
          @method('delete')
